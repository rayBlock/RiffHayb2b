...
const Transition: React.FC<{
	...
	const exitingSequence = !React.isValidElement(exitingElement) ? (
		...
		<Sequence
			...
			durationInFrames={(exitingElement.props as { durationInFrames: number }).durationInFrames}
		>
			{exitingElement}
		</Sequence>
	);
	...
	const enteringSequence = !React.isValidElement(enteringElement) ? (
		...
		<Sequence
			from={from}
			durationInFrames={(enteringElement.props as { durationInFrames: number }).durationInFrames}
		>
			{enteringElement}
		</Sequence>
	);
