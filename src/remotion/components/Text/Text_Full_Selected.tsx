...
export const Text_A_Selected: React.FC<TextProps> = ({
    ...
    return (
        <div className={cn(selected ? "border absolute  border-blue-500 text-red-500 px-3 py-2 " : "","")}>
            ...
            <p
                ...
                style={{
                    background: mergedProps.linearBG ? `linear-gradient(${mergedProps.linearDegBG}deg, ${mergedProps.colorBG}, ${mergedProps.colorBG2})` : mergedProps.colorBG,
                    width: `max-content`,
