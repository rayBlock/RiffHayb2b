	...
	return (
		<BuilderLayout>
			...
			<main ref={mainWindowRef} className='flex flex-col h-screen relative'>
				...
				{/* Dimension Select  */}
				<div className='absolute bottom-0 top-2/3 z-10 lg:flex hidden flex-col right-2'>
					<select
						id="playerSize"
				...
				<div className='flex justify-center '>
					...
					<div ref={playerWrapperRef}
						className={clsx('flex sm:pt-4 w-fit justify-center')}>
						<Player
							ref={playerRef}
				...
				<ImagesEditor playerWidth={playerWrapperWidth} playerRef={playerRef} currentRiff={riffsTime} orientation={ori} mainWindow={mainWindowWidth} propsState={redPropsState} propsActions={redPropsActions} positionData={positionState} positionAction={positionActions} />
